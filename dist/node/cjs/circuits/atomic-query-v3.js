...
class AtomicQueryV3PubSignals extends common_1.BaseConfig {
    ...
    pubSignalsUnmarshal(data) {
        ...
        fieldIdx++;
        //  - claimSchema
        this.claimSchema = js_iden3_core_custom_1.SchemaHash.newSchemaHashFromInt(BigInt(sVals[fieldIdx]));
        fieldIdx++;
        // - ClaimPathKey
        ...
        // - verifierID
        if (sVals[fieldIdx] !== '0') {
            this.verifierID = js_iden3_core_custom_1.Id.fromBigInt(BigInt(sVals[fieldIdx]));
        }
        fieldIdx++;
        // - nullifierSessionID
